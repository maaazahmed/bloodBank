...
class AB_negetive extends Component {
    constructor() {
        super()
        this.state = {
            modalVisible: false,
    ...
    postData(data) {
        ...
        this.props.postPath("AB_negetive")
    }
                    ...
                    <View>
                        {this.props.allPost.post.map((val, ind) => {
                            return (
                                <View key={ind}>
                                    {(val.bloodGroup === "AB-") ?
                                        <Card key={ind} style={{ marginTop: 5 }} >
                                            <TouchableOpacity
...
export default connect(mapStateToProp, mapDispatchToProp)(AB_negetive)